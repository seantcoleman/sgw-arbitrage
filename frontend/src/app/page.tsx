      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-1 gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-green-700 hover:bg-green-600 disabled:bg-zinc-800 disabled:text-zinc-600 disabled:cursor-not-allowed text-white text-sm px-4 py-2 rounded-xl font-semibold transition-all shadow-lg shadow-green-900/30"
          >
            {scanRunning ? (
              <>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-40 text-center">
          ...
          <p className="text-sm text-zinc-600 max-w-xs mb-5">
            Run a scan to find deals. Filters are optional — empty scans browse all listings.
          </p>
          <button
            onClick={handleScanNow}
            disabled={scanRunning}
